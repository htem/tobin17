...
oToPUnitaries_ipsi=[reshape(ornToPn(1:27,[1,2,5]),numel(ornToPn(1:27,[1,2,5])),1);...
    reshape(ornToPn(28:end,[3,4]),numel(ornToPn(28:end,[3,4])),1)];

oToPUnitaries_contra=[reshape(ornToPn(1:27,[3,4]),numel(ornToPn(1:27,[3,4])),1);...
    reshape(ornToPn(28:end,[1,2,5]),numel(ornToPn(28:end,[1,2,5])),1)];
...
ornPnUnitaries{3}=ornToOrn(find(ornToOrn>0));
