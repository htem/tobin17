...
This is the script should prepare latTask_eq simulation dirs for all PNs.
Run this before running the equalized lateralization task simulations
...
path1=['../../nC_projects_lite/',PN,'_allORNs/simulations/latTask_eq/'];
cd(path1)
